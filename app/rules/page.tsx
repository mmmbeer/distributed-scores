...
const description = "Clear scoring guides for volleyball, basketball, football, tennis, baseball, hockey, soccer, pickleball, and badminton, with official rule sources.";
